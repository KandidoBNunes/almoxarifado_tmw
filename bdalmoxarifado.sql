...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26/06/2024 às 20:51
...
(31, 'eu', 'eu@gmail.com', '342342', '2222-02-22', 'outro', '22222', 'comum', 'ativo');
...
(20, 'switch intelbras', '120.00', '70', 'A113', '2010-02-20', '2030-11-11', b'1', NULL, NULL),
(34, 'adaptador universal', '40.00', '2', 'A113', '2000-01-01', '2020-01-01', b'1', NULL, NULL),
(46, 'caixa de parafuso', '49,99', '1', 'C13', '2024-06-26', '2034-06-26', b'1', NULL, NULL);
...
--
ALTER TABLE `new_table`
  MODIFY `idnew_table` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
